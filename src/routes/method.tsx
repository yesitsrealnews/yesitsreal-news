  ...
  return (
    <LegalPage titleKey="method">
      ...
      <ol className="list-decimal space-y-3 ps-5">
        ...
        <li>Triage: is it news or satire? Category, country, duplicates, sensitivity.</li>
        <li>Draft: 400–900 words in a news voice. Accurate headline. Two to six sources.</li>
