  ...
  return (
    <DropdownMenu.Root onOpenChange={() => setQ("")}>
      <DropdownMenu.Trigger asChild>
        <button
          type="button"
          className="inline-flex h-11 min-w-11 items-center gap-1.5 px-2 text-xs font-medium uppercase tracking-[0.16em] text-ink hover:bg-paper-2"
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          align="end"
          className="z-50 max-h-[min(70vh,28rem)] w-72 overflow-hidden border border-rule bg-paper text-ink"
        >
